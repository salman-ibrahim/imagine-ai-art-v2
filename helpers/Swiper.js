...
import {
  ...
  StyleSheet,       Text,       // CSS-like styles
  View,             // Container component
} from 'react-native';
import { markUserOnboarded } from './commonHelpers';
  ...
  renderPagination = () => {
    ...
    renderButton = () => {
        ...
        <View pointerEvents="box-none" style={[styles.buttonWrapper, styles.fullScreen]}>
            ...
            ? 
            <>
                <Button appearance='outline' style={styles.button} status='info' accessoryRight={this.renderRightArrowIcon} onPress={() => markUserOnboarded()}>Get Started</Button>
                <TermsModal/>
            </>
            // Or this one otherwise
            : <Button appearance='outline' style={styles.button} status='info' accessoryRight={this.renderRightArrowIcon} onPress={() => this.swipe()}>Next</Button>
            }
        </View>
        );
    }
